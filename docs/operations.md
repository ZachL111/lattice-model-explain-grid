...
`lattice-model-explain-grid` is centered on ml utilities work in Haskell. The technical target is: Create a Haskell reference implementation for explain workflows, centered on constraint solving, bounded scenario files, and conflict explanations.
...
The score is deterministic. The current threshold is 167. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 6.
