"""Regression checks for the lattice-model-explain-grid casebook."""
...
from casebook.harness import assert_expected, lattice_model_explain_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_model_explain_grid_summary(), assert_expected())
